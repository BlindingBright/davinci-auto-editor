...
# ---- V2.0: Audio Ducking Settings ----
DUCKING_DEPTHS = {
    "vlog":      -10.0,   # Gentle duck for natural conversation
    "reel":      -14.0,   # Moderate — music still present
    "cinematic": -8.0,    # Subtle — music is important
    "hyper":     -18.0,   # Aggressive — speech must cut through
}

# ---- V2.0: SFX Settings ----
SFX_DIR = os.path.join(BASE_DIR, "assets", "sfx")
SFX_VOLUME = {
    "vlog":      0.4,     # Subtle whooshs
    "reel":      0.7,     # Noticeable impacts
    "cinematic": 0.3,     # Very subtle
    "hyper":     1.0,     # Full blast
}

# ---- V2.0: Render Settings ----
DEFAULT_RENDER_DIR = os.path.join(os.path.expanduser("~"), "Videos", "DaVinci Auto-Editor")
DEFAULT_RENDER_PRESET = "youtube_1080"
