...
# ── PyInstaller / frozen binary support ─────────────────────────────────────
# When bundled with PyInstaller (--onefile), __file__ points inside the
# extracted _MEIPASS temp dir. Use that as BASE_DIR so bundled assets resolve.
